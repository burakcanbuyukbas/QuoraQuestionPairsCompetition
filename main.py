...
# GoogleNews-vectors-negative300 hosts the word2vec pre-trained Google News corpus (3 billion running words)
...
# This is equivalent to concatenation along the first axis after 1-D arrays of shape (N,)
# have been reshaped to (1,N). Rebuilds arrays divided by vsplit.
...
# and were refined and popularized by many people in following work.1 They work tremendously well on a
...
submission.to_csv('burakcanbuyukbas.csv', index=False)



# reference: https://www.kaggle.com/lystdo/lstm-with-word2vec-embeddings
